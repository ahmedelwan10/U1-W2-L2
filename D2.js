...
/* SCRIVI QUI LA TUA RISPOSTA */
let number3 = 5
if (number3 >= 5) {console.log ("not equal")}
...
let number4 = 8
let trueNumber = 8
if (trueNumber >= 8) {console.log(trueNumber)}
...
if (totalShoppingCart >= 50) {console.log("costo spedizione 10")}
